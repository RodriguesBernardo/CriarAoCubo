...
<head>
    <meta charset="UTF-8">
    <title>Pedido #{{ $pedido->id }} - Criar³</title>
    ...
    <div class="page">
        <div class="header">
            ...
            <div class="empresa-info">
                ...
                <p class="empresa-contato">Status: Aprovado</p>
            </div>
        </div>
        ...
        <div class="info-box">
            <div class="info-cliente">
                ...
                <p>Endereço: {{ $pedido->cliente->endereco ?? 'A combinar' }}</p>
            </div>
            <div class="info-documento">
                <h3>ENTREGA</h3>
                <p>Previsão: {{ $pedido->data_entrega_prevista ? $pedido->data_entrega_prevista->format('d/m/Y') : ($pedido->dias_entrega ? $pedido->dias_entrega . ' dias' : 'A combinar') }}</p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        R$ {{ number_format($produto->pivot->desconto, 2, ',', '.') }}
                        @else
                        -
                        @endif
                    </td>
